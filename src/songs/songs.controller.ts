import { Body, Controller, DefaultValuePipe, Delete, Get, HttpStatus, Inject, Param, ParseIntPipe, Post, Put, Query, Req, Scope, UseGuards } from '@nestjs/common';
...
import { ArtistsJwtAuthGuard } from 'src/auth/artists-jwt-guard';
